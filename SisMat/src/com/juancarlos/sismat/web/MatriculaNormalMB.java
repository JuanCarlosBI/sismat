...
private String nombreSeccion;
	...
	public void agregar(){
	 ...
	 public OrderBean getOrder() {
	    ...
	    public void onEdit(RowEditEvent event) {  
	        FacesMessage msg = new FacesMessage("Curso Editado",((OrderBean) event.getObject()).getMotivo());  
	    ...
	    public void nombSeccion(){
	    	nombrseccion=matriculaService.nombreSec(codigoColegio, nombreSeccion,grado,nivelAcademico);
	  ...
	  idtutor=secciones.getIdTutor();
	  		...
	  		if(nombrseccion == null){
				...
				this.vacantes=null;
					...
					FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(FacesMessage.SEVERITY_INFO,"No se encontro seccion",""));
					this.nombretutor=null;
					this.nombrecotutor=null;
					this.aula=null;
					this.vacantes=null;
	...
	public void listaSeccion(){
		seccion = matriculaService.listaSeccion(codigoColegio, grado,nivelAcademico);
		...
		curso = matriculaService.listaCurso(codigoColegio,grado,nivelAcademico);
	...
	public void registrarMatricula() {
		boolean resultado = matriculaService.registroMatricula(idAlumno, idSeccion, periodo, situacion, antColegio, codigoColegio);
