...
<%-- <% response.sendRedirect("pages/menu1.jsf"); %> --%>
...
<%-- <% response.sendRedirect("pages/profesores.jsf"); %> --%>
<%-- <% response.sendRedirect("pages/registroProfesor.jsf"); %> --%>
<%-- <% response.sendRedirect("pages/registroAlumno.jsf"); %> --%>
...
<%-- <% response.sendRedirect("pages/holi.jsf"); %> --%>